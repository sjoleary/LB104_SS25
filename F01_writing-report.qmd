...
Before you start writing paragraphs, create an outline to clarify your thinking and then your writing. Start with the key components, then for each section add your main points and the supporting details[^f01_writing-report-2]. At this bare bones stage you are just looking at the skeleton and so it is easier to spot anything in that paragraph that does not belong in there or needs to be in another place. Flesh out each "main point" into a topic sentence and gradually build out your supporting points into full sentences.

[^f01_writing-report-2]: You may find that some of your supporting details are actually main points and vice versa it is a lot easier to move those around at this point.

### Don't write your report linearly: {#sec-dont-write-your-report-linearly}

Start with the last statement in your introduction[^f01_writing-report-3] which summarizes your experimental design and objectives and will serve to transition between your introduction and method section.

[^f01_writing-report-3]: Think of this as a trailer previewing the remainder of a season "This season on XXX"
...
Next, move onto your methods. Then, take the subheading of your methods and fill in the results for each section. Now that you have your results you can write the first section of your discussion[^f01_writing-report-4]. This summarizes your key findings and connects them to your hypothesis. It serves as a transition from your results to your discussion where you will interpret your results.

[^f01_writing-report-4]: Think of this as the quick summary before a tv episode "Previously, on XXX
...
-   Avoid being jargon-y[^f01_writing-report-5].
-   Be specific and concrete. For example, use "for 48 hours", not "a period of time".

[^f01_writing-report-5]: Make sure people know the words you are using, for example, by defining them the first time they are used.
...
-   Clearly state the purpose of your research, you should state what your hypothesis is, what you expect to find and why, and how you are testing this[^f01_writing-report-8].

[^f01_writing-report-8]: No details about your methods/results yet at this point, just brief "how".

You should always have at least two paragraphs. The first, sets up the broad context[^f01_writing-report-9].The last paragraph summarizes what the specific study at hand is investigating and how that will be done. It forms a “bridge” between the introduction that sets up relevant background information (why is my question important?) and the methods section which is a very detailed account of how data was acquired (experimental design), processed, and analyzed.

[^f01_writing-report-9]: For a lab report you can likely do this in a single paragraph, in a longer research paper you will likely then take several following paragraphs to flesh out relevant background information
...
You results section should include a written description along with data visualizations in the form of tables and figures that present your results in a way that makes it easy for the reader to identify key findings[^f01_writing-report-11]. Focus on describing trends and patterns and report which findings are significant. Highlight notable results, when you mention anomalous and unexpected results make sure you pick up on those in the discussion. Remember that you should not be interpreting your data by comparing them to results from other studies, or interpreting them in the context of your research hypothesis.

[^f01_writing-report-11]: You should not include any raw data, it should always be summarized/analyzed.
...
Transition from your results section by making an explicit statement whether your results support your research question or not[^f01_writing-report-13]. A good way to do this is by reiterating the original (broad) question you asked with short description of how you specifically investigated it, your key results[^f01_writing-report-14], and then interpreting/discussing those. Similar to the last paragraph of your introduction section, you can essentially follow a fill-in-the-blank-formula, which as you become more comfortable communicating your research will sound a little less formulaic and a little bit more you[^f01_writing-report-15]:

[^f01_writing-report-13]: Remember that we generally use the terms "support" and "reject" when referring to a hypothesis not "prove" and "disprove"

[^f01_writing-report-14]: Make sure that you are making a very concise summary, not restating all of your results in detail.

[^f01_writing-report-15]: Notice how this statement is quite similar to how you ended your introduction, except now you have the results/an answer.
...
-   Interpret your results and compare them to your expectations and other studies[^f01_writing-report-16]:
...
-   Discuss constraints/limitations, inconsistencies, other possible explanations[^f01_writing-report-17]
...
-   Discuss implications of your results[^f01_writing-report-18].
...
[^f01_writing-report-16]: In this semester we will generally keep the "compare to other studies very small, don't worry, you won't have to go on an extended literature search.

[^f01_writing-report-17]: This is still really specific to your study.

[^f01_writing-report-18]: Now you are broadening your scope to the broader context in which you asked your question
...
Your discussion should comprise about 40-45% of your Lab report[^f01_writing-report-19]

[^f01_writing-report-19]: The more practice you get, the more you will find that this is the case.
