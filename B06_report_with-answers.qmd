...
The next step is write your methods section that elaborates on your summary[^b06_report_with-answers-1]. It can be helpful to structure your method section with subheadings to include important components of your study.

[^b06_report_with-answers-1]: Well, at this point we'll make our first notes that we can then use as an outline to write our report.
...
-   Interpret your results and compare them to your expectations and other studies[^b06_report_with-answers-2]:
...
-   Discuss constraints/limitations, inconsistencies, other possible explanations[^b06_report_with-answers-3]
...
-   Discuss implications of your results[^b06_report_with-answers-4].
...
[^b06_report_with-answers-2]: In this semester we will generally keep the "compare to other studies very small, don't worry, you won't have to go on an extended literature search.

[^b06_report_with-answers-3]: This is still really specific to your study.

[^b06_report_with-answers-4]: Now you are broadening your scope to the broader context in which you asked your question
...
-   Clearly state the purpose of your research, you should state what your hypothesis is, what you expect to find and why, and how you are testing this[^b06_report_with-answers-5].

[^b06_report_with-answers-5]: No details about your methods/results yet at this point, just brief "how".

You should always have at least two paragraphs. The first, sets up the broad context[^b06_report_with-answers-6].

[^b06_report_with-answers-6]: For a lab report you can likely do this in a single paragraph, in a longer research paper you will likely then take several following paragraphs to flesh out relevant background information
...
Typically, we document **another authors specific words and phrases** and **information and ideas** with citations pointing towards the original author (primary literature or grey literature[^b06_report_with-answers-7]) or works that have analyzed, synthesized, and interpreted primary research (secondary literature[^b06_report_with-answers-8]). Papers in the humanities and literary analysis frequently use direct quotations because that is essentially your data and you need to present it to support your analysis of specific words and phrases. In the social and natural sciences we **summarize, paraphrase** [^b06_report_with-answers-9] and then **attribute** the specific pieces of information (frequently data/results, or examples/case studies) and individual ideas/arguments, methods, theories, processes etc. to the original author.

[^b06_report_with-answers-7]: Primary literature refers to original research findings published in a peer-reviewed journal, grey literature is information not published through traditional journals that have undergone some sort of review/fact checking like government reports or internal company documents.

[^b06_report_with-answers-8]: Secondary literature typically appears as review articles or textbooks and summarizes primary literature for a specific topic. Review articles can sometimes fall into both primary and secondary literature. A review article that synthesizes other work to produce something new or formalize a certain argument/theory for the first time is frequently considered primary literature.

[^b06_report_with-answers-9]: There should be no direct quotations in your lab report!
